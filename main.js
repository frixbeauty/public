...
const i18n = {
  ...
  en: {
    ...
    "hero.lead":
      "Tell us where you’ll be and your preferred time window. We’ll connect you with the best‑fit designer near your stay—selected for style match and convenience.",
    ...
    "form.subtitle": "You don’t need to know the salon name—we’ll pick the right designer for you.",
    "form.region": "Where will you be?",
    "form.regionPlaceholder": "Select region",
    "form.neighborhood": "Hotel name, neighborhood, or landmark",
    ...
    "form.note": "Exact time is confirmed by the designer after review.",
    ...
    "steps.one": "Start curation",
    "steps.oneBody": "Location, date, and preferred time window",
    "steps.two": "Style translation",
    "steps.twoBody": "Share text or images in your own words",
    "steps.three": "Designer handoff",
    "steps.threeBody": "Frix sends your request before confirmation",
    "modal.close": "Close",
